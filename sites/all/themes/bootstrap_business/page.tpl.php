...
<header id="header" role="banner" class="clearfix">
	<video loop muted autoplay poster="/wotlk.jpg" class="headbgv">
        <source src="/wotlk.mp4" type="video/mp4"></source>
    </video>
    <div class="container">
    ...
    <div class="container">
        ...
        <div id="main-navigation-inside" class="clearfix">
            <div class="row">
				...
				/*
	                $charid=variable_get('defchar'.$user->uid,null);
	                
	                $characters=get_chars_array();
	                
	                if($charid!=null){
						$character=load_char_data($charid);
					} else {
						$charid=variable_set('defchar'.$user->uid,null);
						$characters=get_chars_array();
						$character=load_char_data($characters[0]->name);
					}
					if($character->base){
						print '<li>'.charname($character->base).'</li>';	
					}
				*/
                ?>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <aside class="<?php print $sidebar_grid_class; ?>">  
                    <!--#sidebar-first-->
                    <section id="sidebar-first" class="sidebar clearfix" data-spy="affix" data-offset-top="400"	>
                ...
                <section class="<?php print $main_grid_class; ?>">
                    ...
                    <div id="main" class="clearfix">
                        ...
                        <div id="breadcrumb" class="clearfix" class="clearfix" data-spy="affix" data-offset-top="391">
                            <!-- #breadcrumb-inside -->
